...
# ============================================================
# بيانات الحساب (مضبوطة)
# ============================================================

EMAIL = "maikhaled918273@gmail.com"
PASSWORD = "010011012"
ASSET = "EURUSD_otc"  # ممكن تغيره لأي زوج
...
def main():
    ...
    if signals:
        ...
        print("\n✅ تم حفظ الإشارات في all_perfect_signals.txt")
        print("✅ تم حفظ الإشارات في signals.csv")
        
        # عرض أول 5 إشارات
        print("\n📋 أول 5 إشارات:")
        print(df_signals.head().to_string(index=False))
